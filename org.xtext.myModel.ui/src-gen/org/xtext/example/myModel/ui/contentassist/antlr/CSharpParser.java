		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getDeclarationStatementAccess().getGroup_0(), "rule__DeclarationStatement__Group_0__0");
					put(grammarAccess.getDeclarationStatementAccess().getGroup_1(), "rule__DeclarationStatement__Group_1__0");
					put(grammarAccess.getLocalConstantDeclarationAccess().getGroup(), "rule__LocalConstantDeclaration__Group__0");
					put(grammarAccess.getLocalConstantDeclarationAccess().getGroup_2(), "rule__LocalConstantDeclaration__Group_2__0");
