		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getStructModifierAccess().getAlternatives(), "rule__StructModifier__Alternatives");
					...
					put(grammarAccess.getIndexerDeclaratorAccess().getAlternatives(), "rule__IndexerDeclarator__Alternatives");
					put(grammarAccess.getIndexerModifierAccess().getAlternatives(), "rule__IndexerModifier__Alternatives");
					put(grammarAccess.getEventDeclarationAccess().getAlternatives_4(), "rule__EventDeclaration__Alternatives_4");
					put(grammarAccess.getEventAccessorDeclarationsAccess().getAlternatives(), "rule__EventAccessorDeclarations__Alternatives");
					put(grammarAccess.getEventModifierAccess().getAlternatives(), "rule__EventModifier__Alternatives");
					put(grammarAccess.getAccessorDeclarationsAccess().getAlternatives(), "rule__AccessorDeclarations__Alternatives");
					...
					put(grammarAccess.getIndexerDeclaratorAccess().getGroup_0(), "rule__IndexerDeclarator__Group_0__0");
					put(grammarAccess.getIndexerDeclaratorAccess().getGroup_1(), "rule__IndexerDeclarator__Group_1__0");
					put(grammarAccess.getEventDeclarationAccess().getGroup(), "rule__EventDeclaration__Group__0");
					put(grammarAccess.getEventDeclarationAccess().getGroup_4_0(), "rule__EventDeclaration__Group_4_0__0");
					put(grammarAccess.getEventDeclarationAccess().getGroup_4_0_0(), "rule__EventDeclaration__Group_4_0_0__0");
					put(grammarAccess.getEventDeclarationAccess().getGroup_4_1(), "rule__EventDeclaration__Group_4_1__0");
					put(grammarAccess.getEventAccessorDeclarationsAccess().getGroup_0(), "rule__EventAccessorDeclarations__Group_0__0");
					put(grammarAccess.getEventAccessorDeclarationsAccess().getGroup_1(), "rule__EventAccessorDeclarations__Group_1__0");
					...
					put(grammarAccess.getAccessorDeclarationsAccess().getGroup_0(), "rule__AccessorDeclarations__Group_0__0");
					put(grammarAccess.getAccessorDeclarationsAccess().getGroup_1(), "rule__AccessorDeclarations__Group_1__0");
